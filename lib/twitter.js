var VERSION = '0.2.8',
  ...
  oauth.OAuth.prototype._oldCreateClient = oauth.OAuth.prototype._createClient;
  oauth.OAuth.prototype._createClient = function (port, hostname, method, path, headers, sslEnabled) {
    ...
    return this._oldCreateClient(port, hostname, method, path, headers, sslEnabled);
  }
...
function Twitter(options) {
  ...
  if (this.options.gateway) {
    this.options.headers['X-Forwarded-Host'] = this.options.gateway;
  }
